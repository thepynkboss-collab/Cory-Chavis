...
Contact: info@coryjchavis.com · www.coryjchavis.com
...
(free, no account) and deliver to **info@coryjchavis.com**.

One-time activation: the first time either form is submitted after going live,
FormSubmit emails info@coryjchavis.com an activation link. Click it once and all
